...
## 本課範圍
本課（Jobs01）取自演講開場，目標：**一句一句理解並背起來**。

## 使用方式（建議流程）
1. 先看英文句（卡片正面）→ 嘗試回想中文意思
2. 翻面看中文翻譯（主答案）
3. 再看英英解釋（確認你是否真的懂這句在說什麼）
4. 最後讀「中文解釋 + Key terms」：抓住固定 2 個關鍵詞，避免只背翻譯
5. 朗讀 2–3 次（可用 App 的 TTS），讓整句成為一個語塊
...
**EN explanation**: He plans to share three personal stories with the audience.
...
**EN explanation**: He emphasizes that his plan is simple and limited.
...
**EN explanation**: He downplays it to make the tone casual.
...
## 句子 7
**EN**: Just three stories.

**ZH（翻譯）**：就三個故事而已。

**EN explanation**: He repeats that he will tell only three stories.
...
**ZH（翻譯）**：第一個故事是關於把點點滴滴連起來（串起人生的線索）。

**EN explanation**: The first story shows how separate experiences can later connect and make sense.
